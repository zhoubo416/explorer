...
const messages = shallowRef<Msg[]>([
  { role: 'assistant', content: '你好，我是探境。我们从一个问题开始：最近有没有一件事，你一直想做，但还没真正开始？' },
])
  ...
  <div class="flow-view page-enter">
    ...
    <div class="goal-create-layout">
      ...
      <aside class="create-side">
        <span class="eyebrow">为什么从对话开始</span>
        <h2>不用先想清楚，<br><em>我们边走边发现。</em></h2>
        <p>目标不是一开始就完美的答案，而是你愿意先靠近的一条路。</p>
        <div class="create-progress"><span>探索你的方向</span><i class="active" /><i /><i /></div>
      </aside>
    </div>
  </div>
</template>
